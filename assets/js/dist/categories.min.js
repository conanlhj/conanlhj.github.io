...
!(function () {
  ...
  function ht(e, t) {
    ...
    var n = t,
      ...
      g = n.padding,
      m = void 0 === g ? 0 : g,
      v = Ye('number' != typeof m ? m : Ue(m, oe)),
      b = d === ce ? fe : ce,
      y = e.rects.popper,
      _ = e.elements[h ? b : d],
  ...
  var Et = {
    ...
    fn: function (e) {
      var t = e.state,
        ...
        h = n.tetherOffset,
        g = void 0 === h ? 0 : h,
        m = ht(t, { boundary: l, rootBoundary: c, padding: u, altBoundary: f }),
        v = Se(t.placement),
        b = Qe(t.placement),
        y = !b,
        _ = Re(v),
  ...
  var Tt = Lt(),
    ...
    jt = Lt({ defaultModifiers: [et, wt, Je, Te, _t, mt, Et, Ke, yt] }),
    kt = Object.freeze({
      __proto__: null,
      afterMain: be,
      afterRead: ge,
  ...
  const pn = document.getElementById('sidebar'),
    ...
    gn = document.getElementById('mask');
  class mn {
    static toggle() {
      (vn._ = Jt(mn, this, !Jt(mn, this, vn)._)),
        document.body.toggleAttribute('sidebar-display', Jt(mn, this, vn)._),
        pn.classList.toggle('z-2', Jt(mn, this, vn)._),
        gn.classList.toggle('d-none', !Jt(mn, this, vn)._);
    }
  }
  var vn = { _: !1 };
  ...
  Zt(Pn, 'resultVisible', !1),
    ...
    (hn.onclick = gn.onclick = () => mn.toggle()),
