...
description: "Probability Space, Random Variable, Expectation, Lp Space, Independence"
author: shiggy
categories: [공부, "확률미분방정식(SDE)"]
tags: [sde, stochastic calculus, measure theory, probability space, random variable, lp space]
pin: false
math: true
mermaid: true
toc: true
